...
def meilleurs_scores():
    ...
    racine = tk.Tk()
    racine.title("Meilleurs Scores")
    racine.geometry("500x600")
    
    label0 = tk.Label(racine, text="10 Meilleurs Scores", font = ("helvetica", "30"))
    label0.grid(column=5000, row=0)
    label1 = tk.Label(racine, text="1", font = ("helvetica", "30")).grid(column=0, row=1)
    label2 = tk.Label(racine, text="2", font = ("helvetica", "30")).grid(column=0, row=2)
    label3 = tk.Label(racine, text="3", font = ("helvetica", "30")).grid(column=0, row=3)
    label4 = tk.Label(racine, text="4", font = ("helvetica", "30")).grid(column=0, row=4)
    label5 = tk.Label(racine, text="5", font = ("helvetica", "30")).grid(column=0, row=5)
    label6 = tk.Label(racine, text="6", font = ("helvetica", "30")).grid(column=0, row=6)
    label7 = tk.Label(racine, text="7", font = ("helvetica", "30")).grid(column=0, row=7)
    label8 = tk.Label(racine, text="8", font = ("helvetica", "30")).grid(column=0, row=8)
    label9 = tk.Label(racine, text="9", font = ("helvetica", "30")).grid(column=0, row=9)
    label10 = tk.Label(racine, text="10", font = ("helvetica", "30")).grid(column=0, row=10)
    label11 = tk.Label(racine, text=str(scores[0]), font = ("helvetica", "30")).grid(column=1, row=1)
    label12 = tk.Label(racine, text=str(scores[1]), font = ("helvetica", "30")).grid(column=1, row=2)
    label13 = tk.Label(racine, text=str(scores[2]), font = ("helvetica", "30")).grid(column=1, row=3)
    label14 = tk.Label(racine, text=str(scores[3]), font = ("helvetica", "30")).grid(column=1, row=4)
    label15 = tk.Label(racine, text=str(scores[4]), font = ("helvetica", "30")).grid(column=1, row=5)
    label16 = tk.Label(racine, text=str(scores[5]), font = ("helvetica", "30")).grid(column=1, row=6)
    label17 = tk.Label(racine, text=str(scores[6]), font = ("helvetica", "30")).grid(column=1, row=7)
    label18 = tk.Label(racine, text=str(scores[7]), font = ("helvetica", "30")).grid(column=1, row=8)
    label19 = tk.Label(racine, text=str(scores[8]), font = ("helvetica", "30")).grid(column=1, row=9)
    label20 = tk.Label(racine, text=str(scores[9]), font = ("helvetica", "30")).grid(column=1, row=10)
    
    bouton_retour = tk.Button(racine, text="<--", command=retour_menu2, font=("Comic Sans MS", "10"), relief="ridge", bd=5, bg="gainsboro", padx=10).grid()
...
######################## Sauvegarde des 10 meilleurs score :
def sauv_score(score_tot):
    global nb_parties,scores
    if nb_parties <= 10 :
        scores=[].append(score_tot)
        scores.sort(reverse=True)
    else :
...
btn_retour=tk.Button(jeu, text="Retour", command=retour_menu3, font=("Comic Sans MS", "10"), relief="groove", bd=5, bg="gainsboro", padx=18)
...
btn_retour.grid(row=5, column=0)
